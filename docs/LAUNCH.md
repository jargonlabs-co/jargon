...
3. **Plivo** (calling): Auth ID, Auth Token, voice number, XML app, and a SIP endpoint. Answer URL `https://api…/voice/plivo/answer`, hangup `https://api…/voice/plivo/hangup`. Twilio remains a fallback if Plivo is unset.
